...
static const float 	BORDER_TILE					= 0.70f;
...
//static const float  WATER_TILE					= 5.0f;
...
static const float 	FOG_MAX 					= 1.0f; 

//static const float 	FOG_MAX 					= 200.7f;

// Fog of war
static const float 	FOW_MAX 					= 0.75f;
static const float  FOW_CAMERA_MIN				= 10;
static const float  FOW_CAMERA_MAX				= 150;
...
static const float GB_CAM_MAX = 140.0f;
...
static const float BORDER_LIGHT_REMOVAL_FACTOR = 0.30f; // How much of the light calculations that are removed from the borders. 1.0f is no light
...
// -------------    RIM LIGHT (PDXMESH)   -----------------------
// --------------------------------------------------------------
static const float 	RIM_START 		= 0.9f;
static const float 	RIM_END 		= 0.1f;
